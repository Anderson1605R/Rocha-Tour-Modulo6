  ...
  return (
    <div class="max-w-md relative flex flex-col p-4 rounded-md text-black bg-slate-100 ">
      <div class="text-2xl font-bold mb-2 text-[#1e0e4b] text-center">
        Bem vindo ao <span class="text-[#0099FF]">RochaTour</span>
      </div>
      ...
      <form class="flex flex-col gap-3">
        ...
        <div>
          <a class="text-sm text-[#0099FF]" href="#">
            Esqueceu sua senha?
          </a>
        </div>
        <button
          type="submit"
          class="bg-[#0099FF] w-max m-auto px-6 py-2 rounded text-white text-sm font-normal"
        >
          Entrar
        </button>
      </form>
      <div class="text-sm text-center mt-[1.6rem]">
        Não criou sua conta?{" "}
        <Link className="text-sm text-[#0099FF]" href="/userForm">
          Crie de graça!
        </Link>
      </div>
    </div>
